...
public class WriteExcel {
    ...
    public static final int COLUMN_INDEX_UPDATEPAGE = 6;
    public static final int COLUMN_INDEX_TIMECRAWLDATA = 7;
    ...
    private static void writeHeader(Sheet sheet, int rowIndex) {
        ...
        cell = row.createCell(COLUMN_INDEX_UPDATEPAGE);
        cell.setCellStyle(cellStyle);
        cell.setCellValue("Thời gian cập nhật trang web");
    ...
    private static void writeBook(Gold gold, Row row) {
        ...
        cell = row.createCell(COLUMN_INDEX_UPDATEPAGE);
        cell.setCellValue(gold.getUpDatePage());
        cell.setCellStyle(cellStyleFormatNumber);
